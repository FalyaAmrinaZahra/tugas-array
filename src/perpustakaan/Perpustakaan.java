...
public class Perpustakaan {
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("20200040012", "Azzahra Putri"));
        dataMahasiswa.add(new Mahasiswa("20200040095", "Falya Amrina Zahra"));
        dataMahasiswa.add(new Mahasiswa("20200040091", "Nida Aulia Salsa Bila"));
        dataMahasiswa.add(new Mahasiswa("20200040097", "Nurul Islam Hasanah"));

        ArrayList <Buku> dataBuku = new ArrayList<>();

        dataBuku.add(new Buku("001", "dilan"));
        dataBuku.add(new Buku("002", "assalamualaikum beijing"));
        dataBuku.add(new Buku("003", "surga yg tak dirindukan"));
        dataBuku.add(new Buku("004", "laskar pelangi"));
